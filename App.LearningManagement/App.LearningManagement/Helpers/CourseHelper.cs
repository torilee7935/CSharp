...
namespace App.LearningManagement.Helpers
{
    public class CourseHelper
    {
        ...
        public void CreateCourseRecord(Course? selectedCourse = null)
        {
            ...
            if (!isNewCourse)
            {
                Console.WriteLine("Do you want to update the  description?");
                choice = Console.ReadLine() ?? "N";
            }
            else
            {
        ...
        {
            Console.WriteLine("Enter course code to add student to: ");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
        ...
        {
            Console.WriteLine("Enter course code to remove student from: ");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
        ...
        {
            Console.WriteLine("Enter course code to add module to: ");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
        ...
        {
            Console.WriteLine("Enter course code to remove module: ");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
            ...
            if (selectedCourse != null)
            {
                Console.WriteLine("Choose a module to remove: ");
        ...
        {
            Console.WriteLine("Enter course code to update assignment: ");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
            ...
            {
                Console.WriteLine("Enter id for the module to update: ");
                selectedCourse.Modules.ForEach(Console.WriteLine);

                selection = Console.ReadLine();
                var selectedModule = selectedCourse.Modules
                ...
                if (selectedModule != null)
                {
                    ...
                    Console.WriteLine("Would you like to modify the description?");
                    selection = Console.ReadLine();
                    if (selection?.Equals("Y", StringComparison.InvariantCultureIgnoreCase) ?? false)
                    {
        ...
        private void SetupRoster(Course c)
        {
            ...
            Console.WriteLine("Which student do you want to enroll in course? (Q to quit)");
        ...
        {
            Console.WriteLine("Would like to add assignemnts? (Y/N)");
        ...
        {
            Console.WriteLine("Would like to add modules? (Y/N)");
            var assignResponse = Console.ReadLine() ?? "N";
            bool continueAdding;
            if (assignResponse.Equals("Y", StringComparison.InvariantCultureIgnoreCase))
            {
        ...
        {
            Console.WriteLine("Enter course code to update announcement: ");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
        ...
        {
            Console.WriteLine("Enter course code to remove announcement: ");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
        ...
        private PageItem? CreatePageItem(Course c)
        {
            ...
            Console.WriteLine("Enter a page content: ");
        ...
        {
            Console.WriteLine("Enter the code for the course to list the submissions from:");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
        ...
        {
            Console.WriteLine("Enter the code for the course to update the submission from:");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
        ...
        {
            Console.WriteLine("Enter the code for the course to grade the assignment in:");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
        ...
        {
            Console.WriteLine("Enter the code for the course of student for grade:");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
